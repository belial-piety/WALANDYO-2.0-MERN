    ...
    <div>
      ...
      {movementItem && (
        <Modal
          ...
          boxStyle={{ width: '800px', maxWidth: '94vw' }}
        >
          {loadingMovements ? (
            ...
            <div style={{ maxHeight: '360px', overflowY: 'auto' }}>
              <table className="data-table" style={{ fontSize: '13px', width: '100%', tableLayout: 'fixed' }}>
                <thead>
                  <tr>
                ...
                <tbody>
                  {movements.map((m) => (
                    <tr key={m._id}>
                      ...
                      <td style={{ fontSize: '12px', color: '#8a8578', whiteSpace: 'normal', wordBreak: 'break-word' }}>{m.notes || '-'}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
